...
export default function ParameterLine(props) {
    ...
    <>
      <p className={`flex items-start flex-col ${props.className || ""}`}>
        <span className="flex flex-row items-center flex-wrap mb-2">
          ...
          <code className={`${labelClasses}`} title="Parameter C# data type">
            {props.type}
          </code>
          <code
        ...
        <span className="text-[0.95rem] border-gray-300 ml-2 py-1 pl-0 font-secondary">
          {props.description}
        </span>
      </p>
    </>
