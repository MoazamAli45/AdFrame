...
const tabs = ["Upload Photo"];

const FingerPrintTabs = ({ onTabClick }) => {
...
const Chip = ({ text, selected, setSelected, onTabClick }) => {
  return (
    <button
      ...
      } text-sm transition-colors p-1.5 md:px-3 md:py-3 rounded-full relative`}
    >
...
export default FingerPrintTabs;
